...
for (let i = 0; i < inventory.length; i++) {
  if (inventory[i].id === carId) foundCar = inventory[i]
}

console.log(
  `Car 33 is a ${foundCar.car_year} ${foundCar.car_make} ${foundCar.car_model}.`
)
// ==== Challenge 2 ====
...
console.log('carModels: ', carModels.sort())
...
console.log('oldCars length: ', oldCars.length)
...
console.log('BMWAndAudi: ', JSON.stringify(BMWAndAudi))
